...
Ratio screens and conservative DCFs identify *statistically cheap* stocks; some are bargains, some are cheap for good reason. This tool narrows the field and enforces discipline — the final judgement (why is it cheap, and is that temporary?) is deliberately not automated. Nothing here is financial advice.
